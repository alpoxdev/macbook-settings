...
exports.GENERATED_TAB_TITLE_SOURCE_SCAN_LIMIT = exports.GENERATED_TAB_TITLE_MAX_LENGTH = void 0;
exports.deriveGeneratedTabTitle = deriveGeneratedTabTitle;
exports.GENERATED_TAB_TITLE_MAX_LENGTH = 40;
exports.GENERATED_TAB_TITLE_SOURCE_SCAN_LIMIT = 512;
...
function foldGeneratedTabTitleWhitespace(value) {
    let normalized = '';
...
function isGeneratedTabTitleWhitespace(code) {
    return (code === 32 ||
        (code >= 9 && code <= 13) ||
        code === 160 ||
        code === 5760 ||
...
function deriveGeneratedTabTitle(prompt) {
    ...
    const promptPreview = prompt.slice(0, exports.GENERATED_TAB_TITLE_SOURCE_SCAN_LIMIT);
    ...
    return truncateAtWordBoundary(capitalizeFirstLetter(candidate), exports.GENERATED_TAB_TITLE_MAX_LENGTH);
}
